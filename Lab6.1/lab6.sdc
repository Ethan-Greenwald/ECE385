...
create_generated_clock -divide_by 2 -source [get_ports MAX10_CLK1_50] [get_nets {vga_controller:vga|clkdiv}]

# SDRAM CLK
create_generated_clock -source [get_pins { m_lab61_soc|sdrampll|sd1|pll7|clk[1] }] \
                      -name clk_dram_ext [get_ports {DRAM_CLK}]

				
#m_lab61_soc|sdrampll|sd1|pll7|clk[1]
#**************************************************************
...
set_multicycle_path -from [get_clocks {clk_dram_ext}] \
                    -to [get_clocks { m_lab61_soc|sdrampll|sd1|pll7|clk[0] }] \
						  -setup 2
